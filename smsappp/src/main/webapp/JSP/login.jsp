            ...
            <div class="col-md-2 col-lg-7 d-flex align-items-center ">
              <div class="card-body  p-lg-4 text-black ">
                ...
                <form action="login" >
                  ...
                  <div class="d-flex align-items-center mb-2 pb-7">
                    <i class="fas fa-cubes fa-2x me-0" style="color: #ff6219;"></i>
                    <span class="h1 fw-bold mb-1" >Student</span>
                  </div>
                  ...
                  <div class="pt-1 mb-3" >
                    <button data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block d-grid gap-2 col-12 mx-auto" type="submit">Login</button>
                  </div>

                  <a class="small text-muted" href="#!">Forgot password?</a>
                  <p class="mb-2 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="#!" style="color: #393f81;">Register here</a></p>
                </form>
